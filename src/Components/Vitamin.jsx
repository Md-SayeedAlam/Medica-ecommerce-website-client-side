...
const Vitamin = () => {
    ...
    return (
        ...
        <h2 className="text-3xl text-center mb-3">Vitamin</h2>
                  ...
                  <tr key={item._id}>
                    ...
                    <td className="px-1 py-1 text-xs border border-gray-200">
                      <div className="flex justify-center">
                        <button  onClick={()=>handleAddToCart(item)} className="lg:btn lg:bg-green-200 btn-xxs hover:bg-green-200 bg-green-100 lg:text-green-500 text-[10px]">
                          Select
                        </button>
                      </div>
                    </td>
